...
CREATE TABLE IF NOT EXISTS `BD_ES2`.`Conta` (
  ...
  `status` TINYINT(1) NOT NULL DEFAULT true,
  `poupanca_status` TINYINT(1) NOT NULL DEFAULT true,
  PRIMARY KEY (`idConta`))
ENGINE = InnoDB;
...
-- Table `BD_ES2`.`Cartao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `BD_ES2`.`Cartao` ;
...
CREATE TABLE IF NOT EXISTS `BD_ES2`.`Pagamento` (
  ...
  `Cliente_has_Conta_Cliente_idCliente` INT NULL,
  `Cliente_has_Conta_Conta_idConta` INT NULL,
  `valor` FLOAT NOT NULL,
  `data` TIMESTAMP NULL,
  PRIMARY KEY (`idPagamento`),
  INDEX `fk_Pagamento_Cliente_has_Conta1_idx` (`Cliente_has_Conta_Cliente_idCliente` ASC, `Cliente_has_Conta_Conta_idConta` ASC),
  CONSTRAINT `fk_Pagamento_Cliente_has_Conta1`
    FOREIGN KEY (`Cliente_has_Conta_Cliente_idCliente` , `Cliente_has_Conta_Conta_idConta`)
    REFERENCES `BD_ES2`.`Cliente_has_Conta` (`Cliente_idCliente` , `Conta_idConta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `BD_ES2`.`Movimento_Poupanca` (
  ...
  `valor` FLOAT NOT NULL,
  PRIMARY KEY (`data`, `Cliente_has_Conta_Cliente_idCliente`, `Cliente_has_Conta_Conta_idConta`),
  INDEX `fk_Movimento_Poupanca_Cliente_has_Conta1_idx` (`Cliente_has_Conta_Cliente_idCliente` ASC, `Cliente_has_Conta_Conta_idConta` ASC),
  CONSTRAINT `fk_Movimento_Poupanca_Cliente_has_Conta1`
    FOREIGN KEY (`Cliente_has_Conta_Cliente_idCliente` , `Cliente_has_Conta_Conta_idConta`)
    REFERENCES `BD_ES2`.`Cliente_has_Conta` (`Cliente_idCliente` , `Conta_idConta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
