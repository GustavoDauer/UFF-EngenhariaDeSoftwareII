...
CREATE TABLE IF NOT EXISTS `BD_ES2`.`Conta` (
  ...
  `saldo_centavos` TINYINT NOT NULL DEFAULT 0,
  `limite` INT NOT NULL DEFAULT -1000,
...
CREATE TABLE IF NOT EXISTS `BD_ES2`.`Cartao` (
  ...
  PRIMARY KEY (`idCartao`, `Cliente_idCliente`, `Conta_idConta`),
  INDEX `fk_Cartao_Cliente_has_Conta1_idx` (`Cliente_idCliente` ASC, `Conta_idConta` ASC),
